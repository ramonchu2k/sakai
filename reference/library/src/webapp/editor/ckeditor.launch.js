...
sakai.editor.editors.ckeditor.launch = function(targetId, config, w, h) {
	...
	//Some defaults for audio recorder
        ...
        [
            ...
            (sakai.editor.enableResourceSearch
                ? ['Autocomplete','AudioRecorder','ResourceSearch', 'Image','Movie','Flash','Table','HorizontalRule','Smiley','SpecialChar','fmath_formula','FontAwesome']
                : ['Autocomplete','AudioRecorder','Image','Movie','Flash','Table','HorizontalRule','Smiley','SpecialChar','fmath_formula','FontAwesome']),
            '/',
    ...
    if (config) {
		...
		(function() { 
		   ...
		   CKEDITOR.plugins.addExternal('autocomplete',basePath+'autocomplete/', 'plugin.js'); 
			 /*
			 ...
			 */
			 ...
			 ckconfig.extraPlugins+="autocomplete,image2,audiorecorder,movieplayer,wordcount,fmath_formula,autosave,fontawesome";
